                                    ...
                                    <div class="card-body border">
                                        <form action="{{ route('admin.general-setting.update') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="site_name" type="text"  value="{{config('settings.site_name')} class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="site_currency_icon"  value="{{ config('settings.site_currency_icon') }} type="text"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
